...
//UPDATE a doctor
router.put('/api/v1/doctors/:id', auth.verifyToken, doctors.update);

//DELETE one doctor from database
router.delete('/api/v1/doctors/:id', auth.verifyToken, doctors.destroy);
...
router.get('/api/v1/pacients/:id', auth.verifyToken, pacients.show);
